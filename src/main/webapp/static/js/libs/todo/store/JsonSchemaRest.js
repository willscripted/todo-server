define("todo/store/JsonSchemaRest", ["dojo/_base/xhr", "dojo/json", "dojo/_base/declare", "dojo/store/util/QueryResults", "json/schema/lib/validate"
...
return declare("todo.store.JsonSchemaRest", null, {
	...
	constructor: function(/* JsonSchema Obj */ schema, /* String */ contentType, /*todo.store.JsonSchemaRest*/ options){
		// summary:
		//		This is a basic store for RESTful communicating with a server through JSON
		//		formatted data.
		// options:
	...
	put: function(object, options){
		...
		//	returns: Number
		options = options || {};
        if(!this.isValid(object)) { throw "Invalid object"; }
