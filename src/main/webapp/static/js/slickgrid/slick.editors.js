...
(function($) {
    ...
    var SlickEditor = {
        ...
        YesNoCellFormatter : function(row, cell, value, columnDef,
                                      dataContext) {
            return value ? "Yes" : "No";
        },

        BoolCellFormatter : function(row, cell, value, columnDef,
                                     dataContext) {
            return value ? "<img src='../images/tick.png'>" : "";
        },

        TaskNameFormatter : function(row, cell, value, columnDef, 
                                     dataContext) {
            // todo:  html encode
            var spacer = "<span style='display:inline-block;height:1px;"
                             + "width:" + (2 + 15 * dataContext["indent"]) +
                         "px'></span>";
            return spacer + " <img src='../images/expand.gif'>&nbsp;" + value;
        },

        ResourcesFormatter : function(row, cell, value, columnDef,
                                      dataContext) {
            ...
            if (columnDef
                ...
                return (resources
                            .length > 1 ?
                    "<center><img src='../images/user_identity_plus.gif' " :
        ...
        StarFormatter : function(row, cell, value, columnDef, dataContext) {
            return (value) ?
                "<img src='../images/bullet_star.png' align='absmiddle'>" : "";
        },
        ...
        PercentCompleteCellEditor : function(args) {
            ...
            this
                .isValueChanged = function() {
                return (!($input
                              .val() == "" && defaultValue == null)) && ((parseInt($input
                                                                                       .val(),
                                                                                   10) || 0) != defaultValue);
            };
        ...
        StarCellEditor : function(args) {
            ...
            this
                ...
                defaultValue = item[args
                    ...
                    .field];
                $input
                    .css("opacity", defaultValue ? 1 : 0.2);
            };
